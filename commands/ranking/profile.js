...
const bio = doc.info ? await doc.info:null;
    ...
    const badge = doc.data.badge ? await loadImage(doc.data.badge || "https://imgur.com/BnLgepd.png"):null;
    // add the wallpaper
